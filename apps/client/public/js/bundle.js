(() => {
        ...
        e.length &&
          e.forEach(
            (e) =>
              new Dropdown(e, {
                popperConfig: (e) => {
                  const t = { ...e, strategy: "fixed" },
                    n = t.modifiers.find(
                      ({ name: e }) => "preventOverflow" === e
                    )
                  return (
                    void 0 !== n && (n.options = { ...n.options, altAxis: !0 }),
                    t
                  )
                },
              })
  ...
  ;(r.m = s),
    ...
    (() => {
          ...
          $ =
            !0 === g
              ? (function (e, t) {
                  ...
                  return { x: N(n * s) / s || 0, y: N(i * s) / s || 0 }
                })({ x: _, y }, x(r))
              : { x: _, y }
        return (
          (_ = $.x),
      ...
      var Oe = De(),
        Le = De({ defaultModifiers: [ie, ke, te, L, Ee, _e, Ae, Q, we] }),
      ...
      const Dt = {
        ...
        It = `pointerdown${Ot}`,
        Nt = `pointerup${Ot}`,
        jt = { endCallback: null, leftCallback: null, rightCallback: null },
        Pt = {
      ...
      class Bt extends yt {
        ...
        _handleSwipe() {
          ...
          ;(this._deltaX = 0),
            t &&
              Ue(t > 0 ? this._config.rightCallback : this._config.leftCallback)
        }
        _initEvents() {
          this._supportPointerEvents
      ...
      const ps = {
        ...
        fs = { ...hs.DefaultType, content: "(null|string|element|function)" }
      class gs extends hs {
        static get Default() {
          return ps
        }
        ...
        r
          ...
          .then(() => {
            new Chart(_o, {
              ...
              options: {
                scales: {
                  x: { stacked: !0, gridLines: { display: !1 } },
                  y: {
                    stacked: !0,
                    ticks: {
                      callback: (e, t, n) =>
          ...
          .then(() => {
            new Chart(vo, {
              ...
              options: {
                ...
                scales: {
                  x: { ticks: { display: !1 }, grid: { drawOnChartArea: !0 } },
                  y: { display: !1 },
                },
                plugins: {
                  tooltip: {
        ...
        r
          ...
          .then(() => {
            new Chart(wo, {
              ...
              options: {
                plugins: {
                  tooltip: { callbacks: { label: (e) => e.parsed + "%" } },
                },
              },
            })
          })
        ...
        Promise.all([r.e(427).then(r.bind(r, 6329))])
          .then(() => {
            new Chart(Do, {
              ...
              options: {
                plugins: {
                  legend: { display: !0, position: "bottom", align: "center" },
                },
              },
            })
          })
